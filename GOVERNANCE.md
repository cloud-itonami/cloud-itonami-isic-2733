...
`cloud-itonami-isic-2733` is an OSS open-business blueprint for wiring-
device plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a molding/assembly/test-line-equipment action the governor refuses is never dispatched to hardware.
- the Wiring Devices Plant Operations Governor remains independent of the advisor.
...
- bypassing molding/assembly/test-line-equipment-control or record policy checks
