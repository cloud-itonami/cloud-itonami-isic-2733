# Business Model: Manufacture of wiring devices
...
## Classification
- Repository: `cloud-itonami-isic-2733` ([github.com/cloud-itonami/cloud-itonami-isic-2733](https://github.com/cloud-itonami/cloud-itonami-isic-2733))
- ISIC Rev.5: `2733` — Manufacture of wiring devices
- Domain: `:electrical-equipment/manufacturing`
- Social impact: :worker-safety :electrical-safety :product-safety
- Actor: `:wiring-devices-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :electrical-equipment/manufacturing — who wants
...
Capability stack (required): :robotics :identity :forms :dmn :bpmn :audit-ledger :eda :cae.
...
One managed tenant (:electrical-equipment/manufacturing):
...
- Do not bypass the `:wiring-devices-plant-operations-governor` for production decisions.
