# Operator Quickstart — Manufacture of wiring devices

Shortest path from clone to a verified local dry-run for **ISIC 2733** (`cloud-itonami-isic-2733`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2733.git
cd cloud-itonami-isic-2733
```
...
- Blueprint governor key: `wiring-devices-plant-operations-governor`
- Likely source path: `wiringdevmfg.governor.cljc`
